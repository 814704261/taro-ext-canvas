...
export class TaroExtCanvasUtils {
  public static readonly designWidth = 750

  protected CanvasNode: Taro.Canvas | Taro.OffscreenCanvas
  protected ctx: CanvasRenderingContext2D

  protected rpxRatio = 1
  protected readonly clacToPxCache: Map<number | string, number> = new Map()
  protected readonly loadImageCache: Map<string, HTMLImageElement> = new Map()
  protected readonly canvasNaturalSize = {
    width: 0,
    height: 0
  }
  ...
  constructor() {
    ...
    this.rpxRatio = windowWidth / TaroExtCanvasUtils.designWidth
  }
  ...
  protected loadImage(CanvasNode: Taro.Canvas | Taro.OffscreenCanvas, url: string) {
